...
using EfficientPoseNMSImplicitTFTRTOutputsDataType = void* const*;
#else
using EfficientPoseNMSImplicitTFTRTOutputsDataType = void**;
#endif

// TF-TRT CombinedNMS Op Compatibility, for Legacy Implicit Batch Mode
class EfficientPoseNMSImplicitTFTRTPlugin : public nvinfer1::IPluginV2IOExt
{
public:
    explicit EfficientPoseNMSImplicitTFTRTPlugin(EfficientPoseNMSParameters param);
    EfficientPoseNMSImplicitTFTRTPlugin(const void* data, size_t length);
    ~EfficientPoseNMSImplicitTFTRTPlugin() override = default;
    ...
    int32_t enqueue(int32_t batchSize, void const* const* inputs, EfficientPoseNMSImplicitTFTRTOutputsDataType outputs,
...
class EfficientPoseNMSImplicitTFTRTPluginCreator : public nvinfer1::pluginInternal::BaseCreator
{
public:
    EfficientPoseNMSImplicitTFTRTPluginCreator();
    ~EfficientPoseNMSImplicitTFTRTPluginCreator() override = default;
