 ...
 */
#ifndef TRT_EFFICIENT_POSE_NMS_PLUGIN_H
#define TRT_EFFICIENT_POSE_NMS_PLUGIN_H
...
class EfficientPoseNMSONNXPluginCreator : public nvinfer1::pluginInternal::BaseCreator
{
public:
    EfficientPoseNMSONNXPluginCreator();
    ~EfficientPoseNMSONNXPluginCreator() override = default;
